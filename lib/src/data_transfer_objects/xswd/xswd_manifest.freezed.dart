...
class _XswdManifest extends XswdManifest {
  const _XswdManifest({required this.version, required this.id, required this.name, required this.description, required  List<XswdPermission> permissions, this.url}): _permissions = permissions,super._();
