...
class _PeerPeerListUpdatedEvent extends PeerPeerListUpdatedEvent {
  const _PeerPeerListUpdatedEvent({@JsonKey(name: 'peer_id', fromJson: rpcBigInt, toJson: rpcBigIntToJson) required this.id, @JsonKey(name: 'peerlist') required final  List<String> peerList, @JsonKey(includeFromJson: false, includeToJson: false) this.extraFields = const RpcExtraFields()}): _peerList = peerList,super._();
