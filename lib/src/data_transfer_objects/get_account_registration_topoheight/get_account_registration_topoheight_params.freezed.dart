...
bool operator ==(Object other) {
  final _this = this as GetAccountRegistrationTopoheightParams;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetAccountRegistrationTopoheightParams&&(identical(other.address, _this.address) || other.address == _this.address));
}
...
String toString() {
  final _this = this as GetAccountRegistrationTopoheightParams;
  return 'GetAccountRegistrationTopoheightParams(address: ${_this.address})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? address = null,}) {
  return _then(GetAccountRegistrationTopoheightParams(
