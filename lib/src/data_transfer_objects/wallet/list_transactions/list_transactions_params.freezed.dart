...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,asset,minTopoHeight,maxTopoHeight,minTimestamp,maxTimestamp,address,contract,acceptIncoming,acceptOutgoing,acceptCoinbase,acceptBurn,acceptBlob,const DeepCollectionEquality().hash(query),limit,skip);
