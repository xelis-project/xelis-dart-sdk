...
@JsonKey(name: 'signatures') List<SignatureId> get signatures;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Multisig&&const DeepCollectionEquality().equals(other.signatures, signatures));
}
...
/// Create a copy of Multisig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? signatures = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'signatures')  List<SignatureId> signatures)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Multisig() when $default != null:
return $default(_that.signatures);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'signatures')  List<SignatureId> signatures)  $default,) {final _that = this;
switch (_that) {
case _Multisig():
return $default(_that.signatures);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'signatures')  List<SignatureId> signatures)?  $default,) {final _that = this;
switch (_that) {
case _Multisig() when $default != null:
return $default(_that.signatures);case _:
  return null;
...
class _Multisig implements Multisig {
  const _Multisig({@JsonKey(name: 'signatures') required final  List<SignatureId> signatures}): _signatures = signatures;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Multisig&&const DeepCollectionEquality().equals(other._signatures, _signatures));
}
...
/// Create a copy of Multisig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? signatures = null,}) {
