...
@pragma('vm:prefer-inline') @override $Res call({Object? destinations = null,}) {
  return _then(EstimateExtraDataSizeParams(
...
class _EstimateExtraDataSizeParams implements EstimateExtraDataSizeParams {
  const _EstimateExtraDataSizeParams({@JsonKey(name: 'destinations') required  List<String> destinations}): _destinations = destinations;
