...
mixin _$UnsignedTransaction {
 ...
 TransactionType get data; int get fee; int get version; int get nonce; List<int> get source; List<int> get rangeProof; List<Map<String, dynamic>> get sourceCommitments; Reference get reference; Multisig? get multiSig;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,data,fee,version,nonce,const DeepCollectionEquality().hash(source),const DeepCollectionEquality().hash(rangeProof),const DeepCollectionEquality().hash(sourceCommitments),reference,multiSig);
...
@useResult
$Res call({
 TransactionType data, int fee, int version, int nonce, List<int> source, List<int> rangeProof, List<Map<String, dynamic>> sourceCommitments, Reference reference, Multisig? multiSig
});
...
/// Create a copy of UnsignedTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? data = null,Object? fee = null,Object? version = null,Object? nonce = null,Object? source = null,Object? rangeProof = null,Object? sourceCommitments = null,Object? reference = null,Object? multiSig = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TransactionType data,  int fee,  int version,  int nonce,  List<int> source,  List<int> rangeProof,  List<Map<String, dynamic>> sourceCommitments,  Reference reference,  Multisig? multiSig)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnsignedTransaction() when $default != null:
return $default(_that.data,_that.fee,_that.version,_that.nonce,_that.source,_that.rangeProof,_that.sourceCommitments,_that.reference,_that.multiSig);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TransactionType data,  int fee,  int version,  int nonce,  List<int> source,  List<int> rangeProof,  List<Map<String, dynamic>> sourceCommitments,  Reference reference,  Multisig? multiSig)  $default,) {final _that = this;
switch (_that) {
case _UnsignedTransaction():
return $default(_that.data,_that.fee,_that.version,_that.nonce,_that.source,_that.rangeProof,_that.sourceCommitments,_that.reference,_that.multiSig);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TransactionType data,  int fee,  int version,  int nonce,  List<int> source,  List<int> rangeProof,  List<Map<String, dynamic>> sourceCommitments,  Reference reference,  Multisig? multiSig)?  $default,) {final _that = this;
switch (_that) {
case _UnsignedTransaction() when $default != null:
return $default(_that.data,_that.fee,_that.version,_that.nonce,_that.source,_that.rangeProof,_that.sourceCommitments,_that.reference,_that.multiSig);case _:
  return null;
...
class _UnsignedTransaction implements UnsignedTransaction {
  const _UnsignedTransaction({required this.data, required this.fee, required this.version, required this.nonce, required final  List<int> source, required final  List<int> rangeProof, required final  List<Map<String, dynamic>> sourceCommitments, required this.reference, this.multiSig}): _source = source,_rangeProof = rangeProof,_sourceCommitments = sourceCommitments;
  factory _UnsignedTransaction.fromJson(Map<String, dynamic> json) => _$UnsignedTransactionFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$UnsignedTransactionToJson(this, );
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,data,fee,version,nonce,const DeepCollectionEquality().hash(_source),const DeepCollectionEquality().hash(_rangeProof),const DeepCollectionEquality().hash(_sourceCommitments),reference,multiSig);
...
/// Create a copy of UnsignedTransaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? data = null,Object? fee = null,Object? version = null,Object? nonce = null,Object? source = null,Object? rangeProof = null,Object? sourceCommitments = null,Object? reference = null,Object? multiSig = freezed,}) {
