...
class _RpcContractsOutputsResult extends RpcContractsOutputsResult {
  const _RpcContractsOutputsResult({required final  List<ContractTransferExecution> executions, this.extraFields = const RpcExtraFields()}): _executions = executions,super._();
