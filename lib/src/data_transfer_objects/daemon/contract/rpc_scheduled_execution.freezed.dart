...
@pragma('vm:prefer-inline') @override $Res call({Object? hash = null,Object? contract = null,Object? chunkId = null,Object? params = null,Object? maxGas = null,Object? kind = null,Object? gasSources = null,Object? extraFields = null,}) {
  return _then(RpcScheduledExecution(
...
class _RpcScheduledExecution extends RpcScheduledExecution {
  const _RpcScheduledExecution({required this.hash, required this.contract, required this.chunkId, required  List<RpcValueCell> params, required this.maxGas, required this.kind, required  List<RpcGasSourceEntry> gasSources, this.extraFields = const RpcExtraFields()}): _params = params,_gasSources = gasSources,super._();
