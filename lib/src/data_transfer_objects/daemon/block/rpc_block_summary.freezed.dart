...
class _RpcBlockSummary extends RpcBlockSummary {
  const _RpcBlockSummary({required this.blockHash, required this.height, required this.timestamp, required this.miner, required final  List<RpcTransactionSummary> transactions, required this.blockType, required this.difficulty, required this.cumulativeDifficulty, required this.metadata, this.extraFields = const RpcExtraFields()}): _transactions = transactions,super._();
