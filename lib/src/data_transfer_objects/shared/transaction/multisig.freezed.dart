...
class _Multisig extends Multisig {
  const _Multisig({@JsonKey(name: 'signatures') required final  List<SignatureId> signatures, @JsonKey(includeFromJson: false, includeToJson: false) this.extraFields = const RpcExtraFields()}): _signatures = signatures,super._();
