...
@JsonKey(name: 'asset') String get asset;@JsonKey(name: 'commitment') List<int> get commitment;@JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson) RpcJsonValue get validityProof;@JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue) AddressOrPublicKey get destination;@JsonKey(name: 'receiver_handle') List<int> get receiverHandle;@JsonKey(name: 'sender_handle') List<int> get senderHandle;@JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson) RpcJsonValue? get extraData;
...
@useResult
$Res call({
@JsonKey(name: 'asset') String asset,@JsonKey(name: 'commitment') List<int> commitment,@JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson) RpcJsonValue validityProof,@JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue) AddressOrPublicKey destination,@JsonKey(name: 'receiver_handle') List<int> receiverHandle,@JsonKey(name: 'sender_handle') List<int> senderHandle,@JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson) RpcJsonValue? extraData
});


$RpcJsonValueCopyWith<$Res> get validityProof;$AddressOrPublicKeyCopyWith<$Res> get destination;$RpcJsonValueCopyWith<$Res>? get extraData;
...
as RpcJsonValue,destination: null == destination ? _self.destination : destination // ignore: cast_nullable_to_non_nullable
as AddressOrPublicKey,receiverHandle: null == receiverHandle ? _self.receiverHandle : receiverHandle // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$RpcJsonValueCopyWith<$Res>? get extraData {
    if (_self.extraData == null) {
    return null;
  }

  return $RpcJsonValueCopyWith<$Res>(_self.extraData!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'asset')  String asset, @JsonKey(name: 'commitment')  List<int> commitment, @JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson)  RpcJsonValue validityProof, @JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue)  AddressOrPublicKey destination, @JsonKey(name: 'receiver_handle')  List<int> receiverHandle, @JsonKey(name: 'sender_handle')  List<int> senderHandle, @JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson)  RpcJsonValue? extraData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransferPayload() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'asset')  String asset, @JsonKey(name: 'commitment')  List<int> commitment, @JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson)  RpcJsonValue validityProof, @JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue)  AddressOrPublicKey destination, @JsonKey(name: 'receiver_handle')  List<int> receiverHandle, @JsonKey(name: 'sender_handle')  List<int> senderHandle, @JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson)  RpcJsonValue? extraData)  $default,) {final _that = this;
switch (_that) {
case _TransferPayload():
return $default(_that.asset,_that.commitment,_that.validityProof,_that.destination,_that.receiverHandle,_that.senderHandle,_that.extraData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'asset')  String asset, @JsonKey(name: 'commitment')  List<int> commitment, @JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson)  RpcJsonValue validityProof, @JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue)  AddressOrPublicKey destination, @JsonKey(name: 'receiver_handle')  List<int> receiverHandle, @JsonKey(name: 'sender_handle')  List<int> senderHandle, @JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson)  RpcJsonValue? extraData)?  $default,) {final _that = this;
switch (_that) {
case _TransferPayload() when $default != null:
return $default(_that.asset,_that.commitment,_that.validityProof,_that.destination,_that.receiverHandle,_that.senderHandle,_that.extraData);case _:
  return null;
...
@override@JsonKey(name: 'ct_validity_proof', fromJson: RpcJsonValue.fromJson, toJson: _rpcJsonToJson) final  RpcJsonValue validityProof;
@override@JsonKey(name: 'destination', fromJson: AddressOrPublicKey.fromJson, toJson: AddressOrPublicKey.toJsonValue) final  AddressOrPublicKey destination;
...
@override@JsonKey(name: 'extra_data', fromJson: _nullableRpcJsonFromJson, toJson: _nullableRpcJsonToJson) final  RpcJsonValue? extraData;
...
@override $RpcJsonValueCopyWith<$Res> get validityProof;@override $AddressOrPublicKeyCopyWith<$Res> get destination;@override $RpcJsonValueCopyWith<$Res>? get extraData;
...
/// Create a copy of TransferPayload
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? asset = null,Object? commitment = null,Object? validityProof = null,Object? destination = null,Object? receiverHandle = null,Object? senderHandle = null,Object? extraData = freezed,}) {
...
as List<int>,validityProof: null == validityProof ? _self.validityProof : validityProof // ignore: cast_nullable_to_non_nullable
as RpcJsonValue,destination: null == destination ? _self.destination : destination // ignore: cast_nullable_to_non_nullable
as AddressOrPublicKey,receiverHandle: null == receiverHandle ? _self._receiverHandle : receiverHandle // ignore: cast_nullable_to_non_nullable
