...
@JsonKey(name: 'decimals') int get decimals;@JsonKey(name: 'name') String get name;@JsonKey(name: 'ticker') String get ticker;@JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson) MaxSupplyMode get maxSupply;@JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson) AssetOwner get owner;@JsonKey(includeFromJson: false, includeToJson: false) RpcExtraFields get extraFields;
...
@useResult
$Res call({
@JsonKey(name: 'decimals') int decimals,@JsonKey(name: 'name') String name,@JsonKey(name: 'ticker') String ticker,@JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson) MaxSupplyMode maxSupply,@JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson) AssetOwner owner,@JsonKey(includeFromJson: false, includeToJson: false) RpcExtraFields extraFields
});


$MaxSupplyModeCopyWith<$Res> get maxSupply;$AssetOwnerCopyWith<$Res> get owner;$RpcExtraFieldsCopyWith<$Res> get extraFields;
...
as AssetOwner,extraFields: null == extraFields ? _self.extraFields : extraFields // ignore: cast_nullable_to_non_nullable
as RpcExtraFields,
  ));
}
/// Create a copy of AssetData
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'decimals')  int decimals, @JsonKey(name: 'name')  String name, @JsonKey(name: 'ticker')  String ticker, @JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson)  MaxSupplyMode maxSupply, @JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson)  AssetOwner owner, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssetData() when $default != null:
return $default(_that.decimals,_that.name,_that.ticker,_that.maxSupply,_that.owner,_that.extraFields);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'decimals')  int decimals, @JsonKey(name: 'name')  String name, @JsonKey(name: 'ticker')  String ticker, @JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson)  MaxSupplyMode maxSupply, @JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson)  AssetOwner owner, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)  $default,) {final _that = this;
switch (_that) {
case _AssetData():
return $default(_that.decimals,_that.name,_that.ticker,_that.maxSupply,_that.owner,_that.extraFields);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'decimals')  int decimals, @JsonKey(name: 'name')  String name, @JsonKey(name: 'ticker')  String ticker, @JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson)  MaxSupplyMode maxSupply, @JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson)  AssetOwner owner, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)?  $default,) {final _that = this;
switch (_that) {
case _AssetData() when $default != null:
return $default(_that.decimals,_that.name,_that.ticker,_that.maxSupply,_that.owner,_that.extraFields);case _:
  return null;
...
class _AssetData extends AssetData {
  const _AssetData({@JsonKey(name: 'decimals') required this.decimals, @JsonKey(name: 'name') required this.name, @JsonKey(name: 'ticker') required this.ticker, @JsonKey(name: 'max_supply', fromJson: _maxSupplyFromJson, toJson: _maxSupplyToJson) required this.maxSupply, @JsonKey(name: 'owner', fromJson: _assetOwnerFromJson, toJson: _assetOwnerToJson) required this.owner, @JsonKey(includeFromJson: false, includeToJson: false) this.extraFields = const RpcExtraFields()}): super._();
...
@override $MaxSupplyModeCopyWith<$Res> get maxSupply;@override $AssetOwnerCopyWith<$Res> get owner;@override $RpcExtraFieldsCopyWith<$Res> get extraFields;
...
/// Create a copy of AssetData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? decimals = null,Object? name = null,Object? ticker = null,Object? maxSupply = null,Object? owner = null,Object? extraFields = null,}) {
