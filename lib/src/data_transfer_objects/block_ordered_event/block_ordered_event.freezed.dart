...
bool operator ==(Object other) {
  final _this = this as BlockOrderedEvent;
...
int get hashCode {
  final _this = this as BlockOrderedEvent;
  return Object.hash(runtimeType,_this.blockHash,_this.blockType,_this.topoheight,_this.extraFields);
}

@override
String toString() {
  final _this = this as BlockOrderedEvent;
  return 'BlockOrderedEvent(blockHash: ${_this.blockHash}, blockType: ${_this.blockType}, topoheight: ${_this.topoheight}, extraFields: ${_this.extraFields})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,blockHash,blockType,topoheight,extraFields);
}
