...
abstract class GetContractModuleResult with _$GetContractModuleResult {
  const factory GetContractModuleResult({
  ...
  const GetContractModuleResult._();

  /// Decodes `RPCVersioned<Versioned<Option<Module>>>`.
  factory GetContractModuleResult.fromJson(Map<String, dynamic> json) =>
      GetContractModuleResult(
