...
bool operator ==(Object other) {
  final _this = this as GetMempoolSummaryResult;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetMempoolSummaryResult&&const DeepCollectionEquality().equals(other.transactions, _this.transactions)&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.extraFields, _this.extraFields) || other.extraFields == _this.extraFields));
}
...
String toString() {
  final _this = this as GetMempoolSummaryResult;
  return 'GetMempoolSummaryResult(transactions: ${_this.transactions}, total: ${_this.total}, extraFields: ${_this.extraFields})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetMempoolSummaryResult&&const DeepCollectionEquality().equals(other.transactions, _transactions)&&(identical(other.total, total) || other.total == total)&&(identical(other.extraFields, extraFields) || other.extraFields == extraFields));
}
