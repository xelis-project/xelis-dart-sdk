...
class _GetMempoolResult extends GetMempoolResult {
  const _GetMempoolResult({@JsonKey(name: 'transactions') required final  List<RpcTransaction> transactions, @JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson) required this.total, @JsonKey(includeFromJson: false, includeToJson: false) this.extraFields = const RpcExtraFields()}): _transactions = transactions,super._();
