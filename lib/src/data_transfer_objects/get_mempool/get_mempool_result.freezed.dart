...
@JsonKey(name: 'transactions') List<RpcTransaction> get transactions;@JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson) BigInt get total;@JsonKey(includeFromJson: false, includeToJson: false) RpcExtraFields get extraFields;
...
@useResult
$Res call({
@JsonKey(name: 'transactions') List<RpcTransaction> transactions,@JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson) BigInt total,@JsonKey(includeFromJson: false, includeToJson: false) RpcExtraFields extraFields
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? transactions = null,Object? total = null,Object? extraFields = null,}) {
  return _then(GetMempoolResult(
transactions: null == transactions ? _self.transactions : transactions // ignore: cast_nullable_to_non_nullable
as List<RpcTransaction>,total: null == total ? _self.total : total // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'transactions')  List<RpcTransaction> transactions, @JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson)  BigInt total, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetMempoolResult() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'transactions')  List<RpcTransaction> transactions, @JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson)  BigInt total, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)  $default,) {final _that = this;
switch (_that) {
case _GetMempoolResult():
return $default(_that.transactions,_that.total,_that.extraFields);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'transactions')  List<RpcTransaction> transactions, @JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson)  BigInt total, @JsonKey(includeFromJson: false, includeToJson: false)  RpcExtraFields extraFields)?  $default,) {final _that = this;
switch (_that) {
case _GetMempoolResult() when $default != null:
return $default(_that.transactions,_that.total,_that.extraFields);case _:
  return null;
...
class _GetMempoolResult extends GetMempoolResult {
  const _GetMempoolResult({@JsonKey(name: 'transactions') required  List<RpcTransaction> transactions, @JsonKey(name: 'total', fromJson: rpcBigInt, toJson: rpcBigIntToJson) required this.total, @JsonKey(includeFromJson: false, includeToJson: false) this.extraFields = const RpcExtraFields()}): _transactions = transactions,super._();
